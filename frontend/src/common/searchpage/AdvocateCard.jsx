  ...
  return (
    <div className="bg-[#fdf3e6] min-h-screen p-4 md:p-8">
      <div className="text-lg font-bold text-black mb-4">
        <i>Advocate {lawyer.user?.username}</i>
      </div>
      ...
      <div className="bg-[#f1d2a9] rounded-xl shadow-xl p-6 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-2xl font-bold text-[#0a043c]">{lawyer.user?.username}</h2>
      ...
      <div className="bg-[#f1d2a9] rounded-xl shadow-lg p-6 mt-6">
        ...
        <p className="text-sm text-black leading-relaxed">
          {showFullBio
            ? `My name is ${lawyer.user?.username}. I have been practicing law for over ${lawyer.experience}+ years, specializing in criminal defense, family law matters, and civil disputes. I hold an LLB and have completed my Master's in Criminal Law from Mumbai University. My journey began with a deep commitment to justice and helping those unaware of their rights. I've successfully represented clients in high-stakes cases and have a very strong record in both trial and settlement negotiations. I offer legal consultancy, draft contracts, and assist with court documentation. Whether it’s navigating a divorce, resolving a property conflict, or defending against criminal charges, I believe in thorough preparation, empathy, and strategic execution.`
            : `My name is ${lawyer.user?.username}. I have been practicing law for over ${lawyer.experience}+ years, specializing in criminal defense, family law matters, and civil disputes...`}
          <span

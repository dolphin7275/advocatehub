...
const Hero = () => {
  return (
    <section id='home' name='home' className="bg-[#0d163d] py-18 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">

        {/* Left - Content */}
        <div className="flex-1">
          <h1 className="text-4xl md:text-6xl text-center font-bold leading-tight text-[#c9a66c] drop-shadow">
          ...
          <div className="mt-6 space-y-3">
            {[
              ...
              <div key={index} className="flex items-start ml-8 gap-2 text-[#fff0d7] text-base">
                <span className="text-[#c9a66c] mt-1">✔</span>
                <span>{item}</span>
              </div>
            ))}
          </div>
          ...
          <div className="mt-8 flex flex-col justify-center sm:flex-row gap-4">
            <button className="bg-[#cc8e2a] hover:bg-[#fff0d7] hover:text-[#0d163d] text-[#fff0d7] cursor-pointer px-6 py-3 rounded-xl text-lg font-semibold transition-all shadow-md">

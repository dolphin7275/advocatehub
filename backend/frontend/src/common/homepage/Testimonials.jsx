...
function Testimonials() {
  ...
  return (
    <section id='testimonials' name='testimonials' className='w-[100%] bg-[#eeebe6] p-10'>
...
function ReviewCard({ review }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300 leading-relaxed text-base text-center mb-4 z-10 whitespace-pre-line">
        {review.review}
      </p>

      <h3 className="text-xl font-bold text-white text-center mt-auto">
        {review.name}
      </h3>
